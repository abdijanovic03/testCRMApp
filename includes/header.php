...
<body class="d-flex h-100 text-center text-white bg-dark">
    ...
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
     ...
     <center>
        ...
        <div class="w-55">
        <a class="nav-link " style="color: white;" aria-current="page" href="index.php"> <h3 class="float-md-start mb-0"> <img class="rounded" src="includes/photo.png" height="48px" width="48px"> JobStep</h3></a>
