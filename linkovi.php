...
while($link1=mysqli_fetch_array($link)){
  ...
  <ul class="dropdown-menu"  aria-labelledby="dropdownMenuLink">
    ...
    <li>     <a  class="dropdown-item"  href="editL.php?id=<?php echo $link1['id']; ?>">Uredi</a> </td>
</li>
...
/*
 $br1=array();
 $br="SELECT  count(a.id) as br from kandidat a join linkovi b on b.id=a.link group by b.id";
 $result1 = mysqli_query($conn,$br);
